...
- Stopping metric correspond à la métrique utilisé pour utiliser un early stopping. Cela permet d'arrêter notre descente de gradient quand la tolérance relative de l'arrêt métrique pour arrêter la formation (si amélioration) est inférieure à cette valeur, ici c'est notre stopping tolerance.
- Activation nous permet de choisir la fonction d'activation des neurones du réseau.
