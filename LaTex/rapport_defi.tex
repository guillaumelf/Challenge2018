...
\paragraph{}
Dans cette section, nous allons détailler les différents algorithmes que nous avons utilisé pour modéliser les données et effectuer nos prédictions. Le schéma sera le suivant pour chaque algorithme :
\begin{itemize}
