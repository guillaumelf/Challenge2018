...
def tune_model(files,villes,train_drop,test_drop,replacement_month,replacement_date,regressor,params,dict_params,nb_cv_folds,output_file):
    for i in range(len(files)):
        file = 'C:/Users/Guillaume/Documents/MASS/M2 MAS/Data Science Project/Challenge2018/R/NA/train/'+files[i]
        file2 = 'C:/Users/Guillaume/Documents/MASS/M2 MAS/Data Science Project/Challenge2018/R/NA/test/'+files[i]
...
var_dropped_train = ['insee']
var_dropped_test = ['insee']
